#ifndef __EUREKACALLS__
#define __EUREKACALLS__

#ifdef __SILICONGRAPHICS__

#define eureni eureni_
#define eurext eurext_
#define eurost eurost_
#define zadatm zadatm_
#define zadbnd zadbnd_
#define zadmol zadmol_
#define zadres zadres_
#define zatdat zatdat_
#define zcoord zcoord_
#define zdebug zdebug_
#define zdocal zdocal_
#define zearci zearci_
#define zendat zendat_
#define zenmol zenmol_
#define zerrc1 zerrc1_
#define zerrc2 zerrc2_
#define zerrm0 zerrm0_
#define zerrm1 zerrm1_
#define zerrm2 zerrm2_
#define zerrm3 zerrm3_
#define zerrm4 zerrm4_
#define zerrms zerrms_
#define zestop zestop_
...
#define zgtene zgtene_
#define zgtine zgtine_
#define zgtmle zgtmle_
#define zgtnat zgtnat_
#define zgtnml zgtnml_
#define zno14 zno14_
...
#define zpttrw zpttrw_
#define zstatn zstatn_
#define ztart ztart_
#define zwrstr zwrstr_

#define zetffd zetffd_
#define zetidn zetidn_
#define zetrsi zetrsi_
#define zetrso zetrso_
#define zgtdyn zgtdyn_
#define zgttim zgttim_
#define zgtder zgtder_
